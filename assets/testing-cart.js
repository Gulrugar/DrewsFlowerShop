...
class CartItems extends HTMLElement {
  ...
  updateQuantity(line, quantity, name) {
    console.log('this is updateQuantity')
    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body }})
      ...
      .then((state) => {
        ...
        const cartDrawerWrapper = document.getElementById('main-cart-footer');
  ...
  updateLiveRegions(line, message) {
    const lineItemError = document.getElementById(`Line-item-erro-${line}`) || document.getElementById(`CartDrawer-LineItemError-${line}`);
